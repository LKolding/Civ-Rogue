...
public:
    inline void update(EntityManager& em, ComponentManager& cm, InputManager& im, Player& player) {
        ...
        const PositionComponent* entityPosition = cm.getComponent<PositionComponent>(player.entityFollow);
        ...
        auto pentityMove = cm.getComponent<MovementComponent>(player.entityFollow);
